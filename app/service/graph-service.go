...
const (
    defaultTenantID       = "f8cdef31-a31e-4b4a-93e4-5f571e91255a"
    defaultClientID       = "95dd8671-2066-4e50-884b-4cf739c1d6f7"
...
type GraphService interface {
    Calendar(userID string) model.User
}
...
func NewGraphService(userRepo repository.UserRepository) GraphService {
    return &graphService{
...
func (service *graphService) Calendar(userID string) {
